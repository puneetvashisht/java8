...
// anonymous way
// lambda way
// java 8 staticMethod way

// lets call Referable : referenceFromHere
public class Demo01_ReferenceToStaticMethod {
	...
	public void implement() {
	      ...
	      // using only abstract method to implement
	      Referable demo2 = (msg) -> Demo01_ReferenceToStaticMethod.staticMethod(msg);
	      demo2.referenceFromHere("Lambda calling static method.");

	      // Method reference.
	      //Referable is FunctionalInterface, 
//	      right side definition will be body of the abstract body
