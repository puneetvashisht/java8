...
public class Demo03_LocalDateTime {
	public static void main(String[] args) {
		...
		// 1. get current time
  		...
  		// 2. get date time object
		System.out.println("Convert to a valid date: "+getDateTime(2017, 2, 10, 23, 23, 23));
//		System.out.println("Convert to a valid date: "+getDate(2017, Month.FEBRUARY, 29, 23, 23, 23));

		// 3. dateTime in given zone
